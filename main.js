...
function toggleOpacityInverseScale() {
  isInverse = !isInverse;
  const handles = opacityRangeSlider.querySelectorAll('.noUi-handle');
  const connectElements = opacityRangeSlider.querySelectorAll('.noUi-connect');
...
function toggleOutlineInverseScale() {
  isInverse = !isInverse;
  const outlineHandles = outlineRangeSlider.querySelectorAll('.noUi-handle');
  const outlineConnectElements = outlineRangeSlider.querySelectorAll('.noUi-connect');
...
document.getElementById('inverseOpacityScaleButton').addEventListener('click', toggleOpacityInverseScale);
document.getElementById('inverseOutlineScaleButton').addEventListener('click', toggleOutlineInverseScale);

...
function toggleInverseScale() {
  ...
  if (isInverse) {
    ...
    connectElements[1].style.background = 'linear-gradient(to right, rgba(118, 118, 118, 0) 0%, rgba(118, 118, 118, 1) 50%, #767676 50%)'; // Gradient from light grey to dark grey
    connectElements[2].style.background = '#767676'; // Dark grey to the right of the right handle
  }
}

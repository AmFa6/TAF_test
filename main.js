...
function toggleInverseScale() {
  ...
  if (isInverse) {
    ...
    handles[0].style.background = '#767676'; // Dark grey inside
    handles[1].classList.add('noUi-handle-left');
    handles[1].style.background = 'rgba(255, 255, 255, 0.0)'; // Transparent inside
    connectElements[0].style.background = '#767676'; // Dark grey to the left of the left handle
    connectElements[1].style.background = 'linear-gradient(to right, #767676 0%, rgba(118, 118, 118, 1) 50%, rgba(118, 118, 118, 0) 100%)'; // Gradient from dark grey to light grey
  } else {
    handles[1].classList.remove('noUi-handle-left');
    handles[1].style.background = '#767676'; // Dark grey inside
    handles[0].classList.add('noUi-handle-left');
    handles[0].style.background = 'rgba(255, 255, 255, 0.0)'; // Transparent inside
    connectElements[0].style.background = 'linear-gradient(to right, rgba(118, 118, 118, 0) 0%, rgba(118, 118, 118, 1) 50%, #767676 50%)'; // Gradient from light grey to dark grey
    connectElements[1].style.background = '#767676'; // Dark grey to the right of the right handle
  }
}
